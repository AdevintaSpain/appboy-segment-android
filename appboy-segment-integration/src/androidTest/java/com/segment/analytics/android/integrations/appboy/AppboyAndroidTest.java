...
public class AppboyAndroidTest {
  ...
  public void testIdentifyCallsChangeUser() {
    ...
    IdentifyPayload identifyPayload = new IdentifyPayload
      ...
      .build();
    AppboyIntegration integration = new AppboyIntegration(ApplicationProvider.getApplicationContext(), Appboy.getInstance(ApplicationProvider.getApplicationContext()), "token", Logger.with(Analytics.LogLevel.DEBUG), true, true, null);
